...
class Problema3AdapterTest {

	private static ControleUniversal cUniversal;
	...
	@BeforeAll
	static void setUp() {
		cUniversal = new ControleUniversal();
		...
		cUniversal.addDispositivo(a1);
		cUniversal.addDispositivo(a2);
		cUniversal.addDispositivo(a3);
		cUniversal.addDispositivo(a4);
		cUniversal.addDispositivo(l1);
		cUniversal.addDispositivo(l2);
		cUniversal.addDispositivo(l3);
		cUniversal.addDispositivo(l4);
		cUniversal.addDispositivo(p1);
		cUniversal.addDispositivo(p2);
		cUniversal.addDispositivo(p3);
		cUniversal.addDispositivo(p4);
	}
	
	@Test
	void testLigarArCondicionado() {
		cUniversal.desligarArCondicionado();
		...
		cUniversal.ligarArCondicionado();
	...
	void testAumentarTemperaturaArCondicionado() {
		...
		cUniversal.aumentarTemperaturaArCondicionado();
	...
	void testDiminuirTemperaturaArCondicionado() {
		...
		cUniversal.diminuirTemperaturaArCondicionado();
	...
	void testDefinirTemperaturaArCondicionado() {
		...
		cUniversal.ligarArCondicionado();
		cUniversal.definirTemperaturaArCondicionado(22);
	...
	void testModoTrabalho() {
		cUniversal.ligarArCondicionado();
		cUniversal.definirTemperaturaArCondicionado(18);
		cUniversal.desligarArCondicionado();
		cUniversal.desligarLampada();
		cUniversal.fecharPersiana();
